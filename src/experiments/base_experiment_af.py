...
af_classifier.augmix_severity = -1
af_classifier.gaussian_blur = False
af_classifier.random_partial_crop = 0 # deactivated for feature computation 
af_classifier.batch_size = 32 
af_classifier.augment_private_images_to_balance = True
af_classifier.max_epochs=50
af_classifier.horizontal_flip_prop = 0
af_classifier.vertical_flip_prop = 0
