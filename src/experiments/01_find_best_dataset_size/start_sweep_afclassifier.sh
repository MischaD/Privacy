...
#conda activate $CONDA/latentprivacy; export CUDA_VISIBLE_DEVICES=1; export PYTHONPATH=/vol/ideadata/ed52egek/pycharm/latent-privacy; python scripts/sweep_id_classifier.py src/experiments/b
#ase_experiment.py train_id_classifier --use_synthetic_af --n_sweeps=10 --data_csv=cxr14supportdevices.csv
